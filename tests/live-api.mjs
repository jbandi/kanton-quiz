...
for (const quizId of ['erkennen', 'finden', 'nachbarn', 'blitz', 'silhouette', 'wappen-erkennen', 'wappen-blitz']) {
...
console.log('✓ Live-API: sieben Ranglisten, Produktions-CORS und no-store.');
